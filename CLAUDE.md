...
**Most recent task:** Initial project setup, Godot installed, this CLAUDE.md drafted.

**Next task:** Initialize Godot project, set up Git, create the empty terrain scene with a basic camera.
